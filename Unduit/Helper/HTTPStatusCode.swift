...
enum ResponseType {
    ...
    /// - clientError: This class of status code is intended for unauthorized.
    case unauthorized
...
enum HTTPStatusCode: Int, Error {
    ...
    var responseStatus:(type: ResponseType, description: String)   {
        ...
        case 500..<600,403:
            return (.serverError,"Server is not reachable, please try again later")
            /*
        case 400:
             return (.tokenExpire, "Your session is expired")
        case 404:
            return (.unauthorized, "Unauthorized User")*/
        case 400..<500:
            return (.clientError,"Invalid values !!")
        default:
            return (.undefined,"Something went wrong, please try again later")
        }
    }
